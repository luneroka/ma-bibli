...
function DashHeader({ activeFilter, setActiveFilter }) {
  ...
  return (
    <div className='flex flex-col md:flex-row gap-2 md:gap-0 justify-between items-center mx-[32px] sm:mx-[64px] lg:mx-[128px] mt-4 md:mt-[32px] mb-4 md:mb-[24px]'>
      {/* Title */}
      ...
      <a
        href='/bibli'
        className='hidden md:flex font-merriweather text-body md:text-body font-light gap-1 mb-4 md:mb-0 md:gap-2 py-1 md:py-2 px-2 md:px-4 bg-primary-btn items-center text-black-75 hover:bg-secondary-btn active:bg-black-75 active:text-white-75'
      >
